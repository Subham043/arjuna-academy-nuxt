...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./pages/knowledge-desk/:slug.vue?vue&type=template&id=211d5789&
var render = function render() {
  ...
  }, [])]), _vm._ssrNode(" "), _vm._ssrNode("<ul class=\"tag-list\">", "</ul>", [_vm._ssrNode("<li><i class=\"ri-calendar-todo-fill\"></i>" + _vm._ssrEscape(" " + _vm._s((_vm$blog6 = _vm.blog) === null || _vm$blog6 === void 0 ? void 0 : _vm$blog6.published)) + "</li> "), _vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<i class=\"ri-user-fill\"></i> "), _c('NuxtLink', {
    attrs: {
      "to": "/leadership-team"
    },
    domProps: {
  ...
  })])], 1)]) : _vm._e()], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"courses-details-area pb-70\">", "</div>", [_vm._ssrNode("<div class=\"courses-details-contact\">", "</div>", [_vm._ssrNode("<div class=\"tab courses-details-tab\">", "</div>", [_vm._ssrNode("<div class=\"tab_content current active\">", "</div>", [_vm._ssrNode("<div class=\"tabs_item\">", "</div>", [_vm._ssrNode("<div class=\"courses-details-tab-content\">", "</div>", [_vm._ssrNode("<div class=\"courses-details-review-form\">", "</div>", [_vm._ssrNode("<h3>Comments:</h3> "), _vm.blogComment.length > 0 ? [_vm._l(_vm.blogComment, function (item, i) {
  ...
  })], 2)])] : [_c('PageDetailLoading')]], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-lg-4\">", "</div>", [_vm._ssrNode("<div class=\"side-bar-area\">", "</div>", [_vm._ssrNode("<div class=\"side-bar-widget\">", "</div>", [_vm._ssrNode("<h3 class=\"title\">Popular post</h3> "), _vm._ssrNode("<div class=\"widget-popular-post\">", "</div>", [_vm.popularBlogLoading ? _c('PopularPostLoading') : _vm._e(), _vm._ssrNode(" "), _vm._l(_vm.popularBlog, function (item, i) {
...
// CONCATENATED MODULE: ./pages/knowledge-desk/:slug.vue?vue&type=template&id=211d5789&
