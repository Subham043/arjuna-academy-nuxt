...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./pages/knowledge-desk/index.vue?vue&type=template&id=7eb8e617&
var render = function render() {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"blog-area\" class=\"blog-area pt-70 pb-70\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"section-title mb-45 text-center\"><h2>Latest from our <b>blogs</b></h2> <p>\n                    Explore The Latest Updates About NEET, JEE, IIT Exams And Foundation Courses\n                </p></div> "), _vm._ssrNode("<div class=\"row justify-content-center\">", "</div>", [_vm.blogLoading ? _c('BlogCardLoading', {
    attrs: {
      "count": 9
    }
...
// CONCATENATED MODULE: ./pages/knowledge-desk/index.vue?vue&type=template&id=7eb8e617&
...
/* harmony default export */ var knowledge_deskvue_type_script_lang_js_ = ({
  ...
  methods: {
    async getBlog(page = 0) {
      ...
      try {
        ...
        const response = await this.$publicApi.get(api_routes["a" /* API_ROUTES */].blog + `?total=9&page=${page}&sort=-published_on`); // eslint-disable-line
  ...
  components: {
    BlogCard: () => __webpack_require__.e(/* import() */ 48).then(__webpack_require__.bind(null, 104)),
