...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/contact-us.vue?vue&type=template&id=9a5a38d4&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"faq-area pt-70 pb-70\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-6\"><div class=\"contact-info-area pb-70\"><div class=\"container\"><div class=\"row justify-content-center\"><div class=\"col-lg-12 col-12 col-sm-8\"><div class=\"contact-info-card\"><i class=\"ri-map-pin-fill\"></i> <h3>Our location</h3> <p>3rd Floor, No.02, CHBCS 1st Layout, 1st Floor, 5th Main, Vijaya Nagar</p></div></div> <div class=\"col-lg-6 col-6\"><div class=\"contact-info-card\"><i class=\"ri-mail-fill\"></i> <h3>Email us</h3> <p><a href=\"mailto:info@aaaedu.in\"><span>info@aaaedu.in</span></a></p></div></div> <div class=\"col-lg-6 col-6\"><div class=\"contact-info-card\"><i class=\"ri-phone-fill\"></i> <h3>Phone</h3> <p><a href=\"tel:+917676642258\">+91 7676642258</a></p></div></div></div></div></div> <div class=\"contact-map-area pb-100\"><div class=\"container\">" + _vm._ssrList(_vm.maps, function (item, i) {
    return "<div class=\"contact-map mb-20\"><div class=\"contact-info-card p-4 rounded\"><iframe" + _vm._ssrAttr("src", item) + "></iframe></div></div>";
  }) + "</div></div></div> "), _vm._ssrNode("<div class=\"col-lg-6\">", "</div>", [_vm._ssrNode("<div class=\"contact-widget-area faq-contact\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"register-form\">", "</div>", [_vm._ssrNode("<div class=\"top-header\"><h3>Get in Touch with us</h3></div> "), _vm._ssrNode("<div class=\"contact-form\">", "</div>", [_c('ValidationObserver', {
    ref: "form",
    scopedSlots: _vm._u([{
      key: "default",
      fn: function ({
...
// CONCATENATED MODULE: ./pages/contact-us.vue?vue&type=template&id=9a5a38d4&
