...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./pages/:branch_slug/courses/:course_slug.vue?vue&type=template&id=f072d732&
var render = function render() {
  ...
  }, [_vm._v("Home")])], 1), _vm._ssrNode(" <li>Courses</li> <li>" + _vm._s((_vm$course2 = _vm.course) === null || _vm$course2 === void 0 ? void 0 : _vm$course2.name) + "</li>")], 2)], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"courses-details-area pt-70 pb-70\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-8\">", "</div>", [!_vm.courseLoading ? [_vm._ssrNode("<div class=\"courses-details-contact\">", "</div>", [_vm._ssrNode("<div class=\"tab courses-details-tab\">", "</div>", [_vm._ssrNode("<div class=\"tab_content current active\">", "</div>", [_vm._ssrNode("<div class=\"tabs_item\">", "</div>", [_vm._ssrNode("<div class=\"courses-details-tab-content\">", "</div>", [_vm._ssrNode((((_vm$course3 = _vm.course) === null || _vm$course3 === void 0 ? void 0 : _vm$course3.branch_details.length) > 0 ? "<div class=\"courses-details-into\">" + _vm._s((_vm$course4 = _vm.course) === null || _vm$course4 === void 0 ? void 0 : _vm$course4.branch_details[0].description) + "</div>" : "<!---->") + " <div class=\"courses-details-into\">" + _vm._s((_vm$course5 = _vm.course) === null || _vm$course5 === void 0 ? void 0 : _vm$course5.description) + "</div> "), ((_vm$course6 = _vm.course) === null || _vm$course6 === void 0 ? void 0 : _vm$course6.branch_details.length) > 0 && ((_vm$course7 = _vm.course) === null || _vm$course7 === void 0 ? void 0 : _vm$course7.branch_details[0].include_staff) === true ? [_vm._ssrNode("<div class=\"section-title text-center\"><span>STAFFS</span> <h2>" + _vm._s((_vm$course8 = _vm.course) === null || _vm$course8 === void 0 ? void 0 : _vm$course8.branch_details[0].staff_heading) + "</h2></div> "), ((_vm$course9 = _vm.course) === null || _vm$course9 === void 0 ? void 0 : _vm$course9.branch_details[0].staffs.length) > 0 ? _vm._ssrNode("<div class=\"row justify-content-center mt-4\">", "</div>", _vm._l((_vm$course10 = _vm.course) === null || _vm$course10 === void 0 ? void 0 : _vm$course10.branch_details[0].staffs, function (item, i) {
    var _vm$course11;
    return ((_vm$course11 = _vm.course) === null || _vm$course11 === void 0 ? void 0 : _vm$course11.branch_details[0].staffs.length) > 0 ? _vm._ssrNode("<div class=\"col-lg-6 col-md-6\">", "</div>", [_c('InstructorCard', {
      attrs: {
        "image": item.image,
  ...
  }), 0) : _vm._e()] : _vm._e(), _vm._ssrNode(" "), ((_vm$course12 = _vm.course) === null || _vm$course12 === void 0 ? void 0 : _vm$course12.branch_details.length) > 0 && ((_vm$course13 = _vm.course) === null || _vm$course13 === void 0 ? void 0 : _vm$course13.branch_details[0].include_topper) === true ? [_vm._ssrNode("<div class=\"section-title text-center\"><span>ACHIEVERS</span> <h2>" + _vm._s((_vm$course14 = _vm.course) === null || _vm$course14 === void 0 ? void 0 : _vm$course14.branch_details[0].topper_heading) + "</h2></div> "), ((_vm$course15 = _vm.course) === null || _vm$course15 === void 0 ? void 0 : _vm$course15.branch_details[0].achievers.length) > 0 ? _vm._ssrNode("<div class=\"row justify-content-center mt-4\">", "</div>", _vm._l((_vm$course16 = _vm.course) === null || _vm$course16 === void 0 ? void 0 : _vm$course16.branch_details[0].achievers, function (item, i) {
    var _vm$course17;
    return ((_vm$course17 = _vm.course) === null || _vm$course17 === void 0 ? void 0 : _vm$course17.branch_details[0].achievers.length) > 0 ? _vm._ssrNode("<div class=\"col-lg-4 col-md-4\">", "</div>", [_c('AchieverStudentCard', {
      attrs: {
        "image": item.image,
        "image_alt": item.image_alt,
        "image_title": item.image_title,
  ...
  })], 2)])])])])])], 1), _vm._ssrNode(" <ul class=\"social-link\"><li class=\"social-title\">Share this course:</li> <li><a" + _vm._ssrAttr("href", `https://www.facebook.com/share.php?u=https://www.aaaedu.in/${_vm.$route.params.branch_slug}/courses/${_vm.$route.params.course_slug}&title=${(_vm$course31 = _vm.course) === null || _vm$course31 === void 0 ? void 0 : _vm$course31.name}`) + " target=\"_blank\"><i class=\"ri-facebook-fill\"></i></a></li> <li><a" + _vm._ssrAttr("href", `https://twitter.com/share?text=${(_vm$course32 = _vm.course) === null || _vm$course32 === void 0 ? void 0 : _vm$course32.name}&url=https://www.aaaedu.in/${_vm.$route.params.branch_slug}/courses/${_vm.$route.params.course_slug}`) + " target=\"_blank\"><i class=\"ri-twitter-fill\"></i></a></li> <li><a" + _vm._ssrAttr("href", `https://www.linkedin.com/shareArticle?mini=true&url=https://www.aaaedu.in/${_vm.$route.params.branch_slug}/courses/${_vm.$route.params.course_slug}&title=${(_vm$course33 = _vm.course) === null || _vm$course33 === void 0 ? void 0 : _vm$course33.name}&source=${(_vm$course34 = _vm.course) === null || _vm$course34 === void 0 ? void 0 : _vm$course34.name}`) + " target=\"_blank\"><i class=\"ri-linkedin-line\"></i></a></li></ul>")], 2)], 2)] : [_c('el-skeleton', {
    staticStyle: {
      "width": "100%"
    },
    attrs: {
...
// CONCATENATED MODULE: ./pages/:branch_slug/courses/:course_slug.vue?vue&type=template&id=f072d732&
...
/* harmony default export */ var _course_slugvue_type_script_lang_js_ = ({
  ...
  components: {
    TestimonialCard: () => __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 207)),
    AchieverStudentCard: () => __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 261)),
    InstructorCard: () => __webpack_require__.e(/* import() */ 12).then(__webpack_require__.bind(null, 258)),
