...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./pages/index.vue?vue&type=template&id=8d7b3fc6&
var render = function render() {
  ...
  return _c('div', [_vm._ssrNode("<div class=\"hero-slider-area\">", "</div>", [_vm.bannerLoading ? _c('BannerCardLoading') : _vm._e(), _vm._ssrNode(" "), !_vm.bannerLoading && _vm.banner.length > 0 ? _vm._ssrNode("<div class=\"hero-slider owl-carousel owl-theme\">", "</div>", [_c('VueSlickCarousel', _vm._b({
    ...
    return _c('div', {
      ...
      staticClass: "col-lg-6 order-2-sm"
    }, [_c('div', {
      ...
      staticClass: "col-lg-6 order-1-sm"
    }, [_c('div', {
...
// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=8d7b3fc6&

// EXTERNAL MODULE: ./components/BlogCard.vue + 4 modules
var BlogCard = __webpack_require__(104);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./components/CourseCard.vue?vue&type=template&id=35937a1e&
var CourseCardvue_type_template_id_35937a1e_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
var CourseCardvue_type_template_id_35937a1e_staticRenderFns = [];

// CONCATENATED MODULE: ./components/CourseCard.vue?vue&type=template&id=35937a1e&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  CourseCardvue_type_template_id_35937a1e_render,
  CourseCardvue_type_template_id_35937a1e_staticRenderFns,
  false,
  null,
  null,
  "dd748b0e"
...
var EventCard = __webpack_require__(105);
...
/* harmony default export */ var string_replace_loader_ref_12_pagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async getBlog(page = 0) {
      ...
      try {
        const response = await this.$publicApi.get(api_routes["a" /* API_ROUTES */].blog + `?total=6&page=${page}&filter[is_popular]=true&sort=-published_on`); // eslint-disable-line
    ...
    async getEvent(page = 0) {
      ...
      try {
        const response = await this.$publicApi.get(api_routes["a" /* API_ROUTES */].event + `?total=6&page=${page}&sort=-id`); // eslint-disable-line
  ...
  components: {
    ...
    WhoWeAreCard: () => __webpack_require__.e(/* import() */ 16).then(__webpack_require__.bind(null, 143)),
    WhatWeDoCard: () => __webpack_require__.e(/* import() */ 15).then(__webpack_require__.bind(null, 144)),
    BannerCardLoading: () => __webpack_require__.e(/* import() */ 47).then(__webpack_require__.bind(null, 149)),
    FeatureCardLoading: () => __webpack_require__.e(/* import() */ 11).then(__webpack_require__.bind(null, 150)),
    CourseCardLoading: () => __webpack_require__.e(/* import() */ 49).then(__webpack_require__.bind(null, 151)),
    ...
    BlogCardLoading: () => __webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 146))
  }
});
