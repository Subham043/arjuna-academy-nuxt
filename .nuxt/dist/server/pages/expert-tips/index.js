...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./pages/expert-tips/index.vue?vue&type=template&id=69fd7c73&
var render = function render() {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"expertTip-area\" class=\"blog-area pt-70 pb-70\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"section-title mb-45 text-center\"><h2>Latest from our <b>expert tips</b></h2> <p>\n                    “Mantras to crack JEE &amp; NEET”\n                </p></div> "), _vm._ssrNode("<div class=\"row justify-content-center\">", "</div>", [_vm._l(8, function (i) {
...
// CONCATENATED MODULE: ./pages/expert-tips/index.vue?vue&type=template&id=69fd7c73&
  ...
  methods: {
    async getExpertTip(page = 0) {
      ...
      try {
        ...
        const response = await this.$publicApi.get(api_routes["a" /* API_ROUTES */].expertTip + `?total=8&page=${page}&sort=-published_on`); // eslint-disable-line
