...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./pages/leadership-team.vue?vue&type=template&id=61af8afe&
var render = function render() {
  ...
  return _c('div', [_c('Breadcrumb', {
    ...
    return _vm._ssrNode("<div" + _vm._ssrClass(null, `instructors-details-area ${i === 0 && 'pt-70'} pb-70`) + ">", "</div>", [(i + 1) % 2 === 0 ? _vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-5 order-1-sm\">", "</div>", [_vm._ssrNode("<div class=\"instructors-details-img faq-img\">", "</div>", [_c('img', {
      directives: [{
        name: "lazy-load",
        rawName: "v-lazy-load"
      }],
    ...
    }, []), _vm._ssrNode(" <div class=\"shape\"><h2><span class=\"badge bg-warning\">" + _vm._s(item.designation) + "</span></h2></div>")], 2)]), _vm._ssrNode(" <div class=\"col-lg-7 order-2-sm\"><div class=\"instructors-details-content pl-20\"><h2>" + _vm._s(item.name) + "</h2> <i class=\"d-inline-flex mb-3 fw-semibold text-success-emphasis bg-success-subtle\">" + _vm._s(item.qualification) + "</i> <div>" + _vm._s(item.description) + "</div></div></div>")], 2)]) : _vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-7 order-2-sm\"><div class=\"instructors-details-content pl-20\"><h2>" + _vm._s(item.name) + "</h2> <i class=\"d-inline-flex mb-3 fw-semibold text-success-emphasis bg-success-subtle\">" + _vm._s(item.qualification) + "</i> <div>" + _vm._s(item.description) + "</div></div></div> "), _vm._ssrNode("<div class=\"col-lg-5 order-1-sm\">", "</div>", [_vm._ssrNode("<div class=\"instructors-details-img faq-img\">", "</div>", [_c('img', {
      directives: [{
        name: "lazy-load",
        rawName: "v-lazy-load"
      }],
    ...
    }, []), _vm._ssrNode(" <div class=\"shape\"><h2><span class=\"badge bg-warning\">" + _vm._s(item.designation) + "</span></h2></div>")], 2)])], 2)])]);
  }) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"instructor-area\" class=\"instructors-area instructors-area-rs pb-70\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"section-title text-center mb-45\"><h2>Our Faculties</h2></div> "), _vm.staffLoading ? _vm._ssrNode("<div class=\"row justify-content-center\">", "</div>", _vm._l(8, function (i) {
    return _vm._ssrNode("<div class=\"col-lg-3 col-md-6 col-sm-6\">", "</div>", [_c('el-skeleton', {
      staticStyle: {
        "width": "100%"
      },
      attrs: {
    ...
    return _vm._ssrNode("<div class=\"col-lg-3 col-md-6 col-sm-6\">", "</div>", [_c('InstructorCard', {
      attrs: {
        "image": item.image,
...
// CONCATENATED MODULE: ./pages/leadership-team.vue?vue&type=template&id=61af8afe&

// EXTERNAL MODULE: ./helper/api_routes.js
var api_routes = __webpack_require__(98);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--12!./pages/leadership-team.vue?vue&type=script&lang=js&
