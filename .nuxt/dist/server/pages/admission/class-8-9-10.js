...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/admission/class-8-9-10.vue?vue&type=template&id=8e7edec8&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"faq-area pt-70 pb-70\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-5\"><div class=\"faq-img\"><img src=\"/images/faq-img.jpg\" alt=\"faq\"> <div class=\"shape\"><img src=\"/images/faq-shape.png\" alt=\"Faq\"></div></div></div> "), _vm._ssrNode("<div class=\"col-lg-7\">", "</div>", [_vm._ssrNode("<div class=\"contact-widget-area pb-70\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"register-form\">", "</div>", [_vm._ssrNode("<div class=\"top-header\"><h3>\n                                        Admission for Class 8, 9 &amp; 10   \n                                    </h3></div> "), _vm._ssrNode("<div class=\"contact-form\">", "</div>", [_c('ValidationObserver', {
    ref: "form",
    scopedSlots: _vm._u([{
      key: "default",
      fn: function ({
        ...
        return [_c('form', {
          ...
          scopedSlots: _vm._u([{
            ...
            fn: function ({
              ...
              }, [_vm._v("Choose Marksheet* "), _c('br'), _vm._v(" "), _c('code', [_vm._v("(Only PDF | JPG | PNG files are allowed. Max-size 512kb)")])]), _vm._v(" "), _c('input', {
                directives: [{
                  name: "model",
                  rawName: "v-model",
                  value: _vm.marks,
...
// CONCATENATED MODULE: ./pages/admission/class-8-9-10.vue?vue&type=template&id=8e7edec8&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admission/class-8-9-10.vue?vue&type=script&lang=js&


/* harmony default export */ var class_8_9_10vue_type_script_lang_js_ = ({
  ...
  methods: {
    async formHandler() {
      ...
      try {
        ...
        await this.$publicApi.post(api_routes["a" /* API_ROUTES */].admission_not_puc, formData);
        this.name = '';
        this.school_name = '';
        this.aadhar = '';
        this.father_name = '';
        ...
        this.$refs.form.setErrors({
          ...
          class: (err === null || err === void 0 ? void 0 : (_err$response27 = err.response) === null || _err$response27 === void 0 ? void 0 : (_err$response27$data = _err$response27.data) === null || _err$response27$data === void 0 ? void 0 : (_err$response27$data$ = _err$response27$data.errors) === null || _err$response27$data$ === void 0 ? void 0 : (_err$response27$data$2 = _err$response27$data$.class) === null || _err$response27$data$2 === void 0 ? void 0 : _err$response27$data$2.length) > 0 && (err === null || err === void 0 ? void 0 : (_err$response28 = err.response) === null || _err$response28 === void 0 ? void 0 : (_err$response28$data = _err$response28.data) === null || _err$response28$data === void 0 ? void 0 : (_err$response28$data$ = _err$response28$data.errors) === null || _err$response28$data$ === void 0 ? void 0 : _err$response28$data$.class[0]),
          percentage: (err === null || err === void 0 ? void 0 : (_err$response29 = err.response) === null || _err$response29 === void 0 ? void 0 : (_err$response29$data = _err$response29.data) === null || _err$response29$data === void 0 ? void 0 : (_err$response29$data$ = _err$response29$data.errors) === null || _err$response29$data$ === void 0 ? void 0 : (_err$response29$data$2 = _err$response29$data$.percentage) === null || _err$response29$data$2 === void 0 ? void 0 : _err$response29$data$2.length) > 0 && (err === null || err === void 0 ? void 0 : (_err$response30 = err.response) === null || _err$response30 === void 0 ? void 0 : (_err$response30$data = _err$response30.data) === null || _err$response30$data === void 0 ? void 0 : (_err$response30$data$ = _err$response30$data.errors) === null || _err$response30$data$ === void 0 ? void 0 : _err$response30$data$.percentage[0]),
          sibling: (err === null || err === void 0 ? void 0 : (_err$response31 = err.response) === null || _err$response31 === void 0 ? void 0 : (_err$response31$data = _err$response31.data) === null || _err$response31$data === void 0 ? void 0 : (_err$response31$data$ = _err$response31$data.errors) === null || _err$response31$data$ === void 0 ? void 0 : (_err$response31$data$2 = _err$response31$data$.sibling) === null || _err$response31$data$2 === void 0 ? void 0 : _err$response31$data$2.length) > 0 && (err === null || err === void 0 ? void 0 : (_err$response32 = err.response) === null || _err$response32 === void 0 ? void 0 : (_err$response32$data = _err$response32.data) === null || _err$response32$data === void 0 ? void 0 : (_err$response32$data$ = _err$response32$data.errors) === null || _err$response32$data$ === void 0 ? void 0 : _err$response32$data$.sibling[0]),
          sibling_occupation: (err === null || err === void 0 ? void 0 : (_err$response33 = err.response) === null || _err$response33 === void 0 ? void 0 : (_err$response33$data = _err$response33.data) === null || _err$response33$data === void 0 ? void 0 : (_err$response33$data$ = _err$response33$data.errors) === null || _err$response33$data$ === void 0 ? void 0 : (_err$response33$data$2 = _err$response33$data$.sibling_occupation) === null || _err$response33$data$2 === void 0 ? void 0 : _err$response33$data$2.length) > 0 && (err === null || err === void 0 ? void 0 : (_err$response34 = err.response) === null || _err$response34 === void 0 ? void 0 : (_err$response34$data = _err$response34.data) === null || _err$response34$data === void 0 ? void 0 : (_err$response34$data$ = _err$response34$data.errors) === null || _err$response34$data$ === void 0 ? void 0 : _err$response34$data$.sibling_occupation[0]),
          sibling_school: (err === null || err === void 0 ? void 0 : (_err$response35 = err.response) === null || _err$response35 === void 0 ? void 0 : (_err$response35$data = _err$response35.data) === null || _err$response35$data === void 0 ? void 0 : (_err$response35$data$ = _err$response35$data.errors) === null || _err$response35$data$ === void 0 ? void 0 : (_err$response35$data$2 = _err$response35$data$.sibling_school) === null || _err$response35$data$2 === void 0 ? void 0 : _err$response35$data$2.length) > 0 && (err === null || err === void 0 ? void 0 : (_err$response36 = err.response) === null || _err$response36 === void 0 ? void 0 : (_err$response36$data = _err$response36.data) === null || _err$response36$data === void 0 ? void 0 : (_err$response36$data$ = _err$response36$data.errors) === null || _err$response36$data$ === void 0 ? void 0 : _err$response36$data$.sibling_school[0]),
          sibling_class: (err === null || err === void 0 ? void 0 : (_err$response37 = err.response) === null || _err$response37 === void 0 ? void 0 : (_err$response37$data = _err$response37.data) === null || _err$response37$data === void 0 ? void 0 : (_err$response37$data$ = _err$response37$data.errors) === null || _err$response37$data$ === void 0 ? void 0 : (_err$response37$data$2 = _err$response37$data$.sibling_class) === null || _err$response37$data$2 === void 0 ? void 0 : _err$response37$data$2.length) > 0 && (err === null || err === void 0 ? void 0 : (_err$response38 = err.response) === null || _err$response38 === void 0 ? void 0 : (_err$response38$data = _err$response38.data) === null || _err$response38$data === void 0 ? void 0 : (_err$response38$data$ = _err$response38$data.errors) === null || _err$response38$data$ === void 0 ? void 0 : _err$response38$data$.sibling_class[0]),
          no_of_sibling: (err === null || err === void 0 ? void 0 : (_err$response39 = err.response) === null || _err$response39 === void 0 ? void 0 : (_err$response39$data = _err$response39.data) === null || _err$response39$data === void 0 ? void 0 : (_err$response39$data$ = _err$response39$data.errors) === null || _err$response39$data$ === void 0 ? void 0 : (_err$response39$data$2 = _err$response39$data$.no_of_sibling) === null || _err$response39$data$2 === void 0 ? void 0 : _err$response39$data$2.length) > 0 && (err === null || err === void 0 ? void 0 : (_err$response40 = err.response) === null || _err$response40 === void 0 ? void 0 : (_err$response40$data = _err$response40.data) === null || _err$response40$data === void 0 ? void 0 : (_err$response40$data$ = _err$response40$data.errors) === null || _err$response40$data$ === void 0 ? void 0 : _err$response40$data$.no_of_sibling[0])
        });
        if (err !== null && err !== void 0 && (_err$response41 = err.response) !== null && _err$response41 !== void 0 && (_err$response41$data = _err$response41.data) !== null && _err$response41$data !== void 0 && _err$response41$data.message) this.$toast.error(err === null || err === void 0 ? void 0 : (_err$response42 = err.response) === null || _err$response42 === void 0 ? void 0 : (_err$response42$data = _err$response42.data) === null || _err$response42$data === void 0 ? void 0 : _err$response42$data.message);
        if (err !== null && err !== void 0 && (_err$response43 = err.response) !== null && _err$response43 !== void 0 && (_err$response43$data = _err$response43.data) !== null && _err$response43$data !== void 0 && _err$response43$data.error) this.$toast.error(err === null || err === void 0 ? void 0 : (_err$response44 = err.response) === null || _err$response44 === void 0 ? void 0 : (_err$response44$data = _err$response44.data) === null || _err$response44$data === void 0 ? void 0 : _err$response44$data.error);
      } finally {
        this.loading = false;
      }
    },
...
// CONCATENATED MODULE: ./pages/admission/class-8-9-10.vue?vue&type=script&lang=js&
 /* harmony default export */ var admission_class_8_9_10vue_type_script_lang_js_ = (class_8_9_10vue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admission/class-8-9-10.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admission_class_8_9_10vue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var class_8_9_10 = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=class-8-9-10.js.map