        ...
        <div class="faq-area pt-70 pb-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="faq-img">
                            <img v-lazy-load data-src="/images/lesson.webp" alt="faq" class="lesson-img" />
                            <div class="shape">
...
export default {
    ...
    methods: {
        ...
        async getSeo() {
            try {
                const response = await this.$publicApi.get(API_ROUTES.seo+`/vrddhi-syllabus-page`); // eslint-disable-line
