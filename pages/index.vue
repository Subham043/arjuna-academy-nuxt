    ...
    <div>
        <div class="hero-slider-area">
                    ...
                    <div v-for="(item, i) in banner" :key="i" class="hero-item">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="hero-img">
                                        <img :src="item.banner_image" class="hero" :alt="item.banner_image_alt" :title="item.banner_image_title" width="550" height="512" data-not-lazy/>
            ...
            <div class="hero-shape">
                <div class="shape1">
                    <img data-src="/images/home-three/shape.png" alt="Shape" width="50" height="50" v-lazy-load/>
                </div>
                <div class="shape2">
                    <img data-src="/images/home-three/shape2.png" alt="Shape" width="50" height="50" v-lazy-load/>
                </div>
            </div>
        </div>
